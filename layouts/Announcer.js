...
import { StyleSheet, Text, View, ScrollView, Animated, ActivityIndicator, Dimensions, TouchableWithoutFeedback, TouchableOpacity, LayoutAnimation, RefreshControl, Image as RNImage } from 'react-native';
      ...
      <>
        ...
        <View style={[styles.head, {marginBottom: 0, borderTopLeftRadius: 40, borderTopRightRadius: 40}]}>
          <View style={{alignItems: "center", justifyContent: "center"}}>
            <View style={{height: 6, width: 55, backgroundColor: "#ccc", borderRadius: 4, marginTop: 3}}></View>
          </View>
          <View style={styles.cardHolder}>
            <Animated.View style={[styles.button, {right: this._getInterpolation(0, 30)}]}>
        ...
        <ScrollView style={{flex: 1, backgroundColor: "#F7F9FB", zIndex: 10}}
