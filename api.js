...
class Api {
  constructor(){
		...
		if(_DEVELOPMENT){
			this.analytics = new Analytics("DEVELOPMENT", {slug: "leeloo", name: "Leeloo", version: "2.6.1"});
		}else{
			this.analytics = new Analytics(ANALYTICS_KEY, {slug: "leeloo", name: "Leeloo", version: "2.6.1"});
		}
		this.isTablet = false;
		this._checkIfTablet();
